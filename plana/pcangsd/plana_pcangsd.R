...
inName="plana_pcangsd.admix.2.Q" # name of the input file to plot, output of ngsAdmix or ADMIXTURE run
...
levels(tbl$pop) = c("Kettle Cove", "Beverly", "Newport", "Cape May")

source("../../plot_admixture.R")
